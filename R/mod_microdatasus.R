...
#'
#' @importFrom shiny NS tagList fluidRow column selectInput selectizeInput sliderInput numericInput actionButton hr helpText downloadButton h4 conditionalPanel showNotification observeEvent req downloadHandler reactiveValues wellPanel div HTML uiOutput renderUI updateSelectInput textInput p tags
    ...
    div(style = "display: flex; gap: 20px; align-items: flex-start; height: calc(100vh - 120px); width: 100%;",
        ...
        div(style = "flex: 0 0 350px; max-width: 350px; min-width: 350px; height: 100%; overflow-y: auto; padding-right: 15px; padding-bottom: 20px;", 
            ...
            wellPanel(style = "background-color: #2c3e50; color: white; border: none; padding: 10px 15px;",
                      ...
                      helpText("As transformações ao lado refletem a base selecionada acima.", style = "color: #bdc3c7; font-size: 0.85em; margin-bottom: 0;")
            ),
        ...
        # LADO DIREITO: Tabela com rolagem horizontal livre corrigida
